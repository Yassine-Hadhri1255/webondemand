        ...
        <header>
            <nav className={`${bgColor} w-full md:static md:text-sm ${state ? "relative z-20" : ""}`}>
                <div className="custom-screen relative items-center mx-auto md:flex">
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <Link href="/" aria-label="Logo">
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                ...
                                />
                                <span className={`${navLinkColor} duration-150`} style={{ fontSize: '25px', fontWeight: 'bold' }}>
                                    WebOnDemand
                                </span>
                            </div>
                        </Link>
                        ...
                        <div className="flex gap-x-3 items-center md:hidden">
                            <button ref={menuBtnEl} role="button" aria-label="Open the menu" className={`p-2 rounded-lg ${navMenuBtnColor}`}
                    ...
                    <div className={`${bgColor} flex-1 md:py-0 md:block md:static md:z-0 ${state ? "absolute z-20 inset-x-0 px-4 py-6 w-full" : "hidden"}`}>
